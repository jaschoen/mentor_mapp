class MentorsController < ApplicationController
  ...
  private
    ...
    def mentor_params
      params.require(:mentor).permit(:first_name, :last_name, :city, :state, :bio, :coach_type, :rating, :price_low, :price_high, :industry, :language, :certification, :skills, :experience, :email)
    end
end
